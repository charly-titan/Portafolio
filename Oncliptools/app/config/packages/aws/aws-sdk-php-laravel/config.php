...
return array(
    ...
    |
    */
    'key'    => (defined("AWS_ACCESS_KEY_ID"))?AWS_ACCESS_KEY_ID:'*********', // Your AWS Access Key ID
    'secret' => (defined("AWS_SECRET_ACCESS_KEY"))?AWS_SECRET_ACCESS_KEY:'************', // Your AWS Secret Access Key

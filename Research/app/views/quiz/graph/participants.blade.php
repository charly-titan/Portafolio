...
<html lang="es">
    ...
    <head>
        ...
        <style>
            ...
            #columns .donus {width:30%;border-radius:4px;border: 1px solid #c3c3c3;margin: 10px 10px;background-color: white;float:left;}
            ...
            .header{height: 30px; background-color:#FAFAFA;  border-bottom: 1px solid #C2C2C2;  text-align: center; padding-top: 5px;}

            #columns .line {width:93%;border-radius:4px;border: 1px solid #c3c3c3;margin: 10px 10px;background-color: white;float:left;}
            ...
            .eje_x{position: relative; left:100%; top:0%; font-size: 14px; font-weight: bold;}

            #registro {height:auto !important;width:30%; float: right;}
    ...
    <body>
        ...
        <div id="content">
            ...
            <div id="columns">
                ...
                <ul class="column">
                    <li class="donus">
                        <header class="header">Total de Usuarios Participantes</header>
                        <div class="widget-body no-padding" style="width:100%;">
                            <div id="donut-graph-Total" class="chart no-padding" ></div>
                            <div id="social_network">
                                <ul class="network">
                                    <li class="social_facebook"><p style="margin-left: 30px;">Facebook:{{isset($qSocial_network[0])?$qSocial_network[0]->ageTotal:0;}}</p></li>
                                    <li class="social_twitter"><p style="margin-left: 30px;">Twitter:{{isset($qSocial_network[2])?$qSocial_network[2]->ageTotal:0;}}</p></li>
                                    <li class="social_gmail"><p style="margin-left: 30px;">Google:{{isset($qSocial_network[1])?$qSocial_network[1]->ageTotal:0;}}</p></li>
                                    <li class=""><p style="margin-left: 250px;"><b>Total:{{isset($socialTotal[0])?$socialTotal[0]->ageTotal:0;}}</b></p></li>
                                </ul>
                    ...
                    <li class="donus">
                        <header class="header">Usuarios Participantes Hombres</header>
                        <div class="widget-body no-padding" style="width:100%;">
                            <div id="donut-graph-Hombres" class="chart no-padding"></div>
                                <div id="social_network">
                                    <ul class="network">
                                        <li class="social_facebook"><p style="margin-left: 30px;">Facebook:{{isset($qSocialGender[0])?$qSocialGender[0]->ageMale:0;}}</p></li>
                                        <li class="social_twitter"><p style="margin-left: 30px;">Twitter:{{isset($qSocialGender[2])?$qSocialGender[2]->ageMale:0;}}</p></li>
                                        <li class="social_gmail"><p style="margin-left: 30px;">Google:{{isset($qSocialGender[1])?$qSocialGender[1]->ageMale:0;}}</p></li>
                                        <li class=""><p style="margin-left: 250px;"><b>Total:{{isset($socialMaleTotal[0])?$socialMaleTotal[0]->ageMale:0;}}</b></p></li>
                                    </ul>                                
                                </div>
                        </div>
                    </li>
                    <li class="donus">
                        <header class="header">Usuarios Participantes Mujeres</header>
                        <div class="widget-body no-padding" style="width:100%;">
                            <div id="donut-graph-Mujeres" class="chart no-padding"></div>
                                <div id="social_network">
                                    <ul class="network">
                                        <li class="social_facebook"><p style="margin-left: 30px;">Facebook:{{isset($qSocialGender[0])?$qSocialGender[0]->ageFemale:0;}}</p></li>
                                        <li class="social_twitter"><p style="margin-left: 30px;">Twitter:{{isset($qSocialGender[2])?$qSocialGender[2]->ageFemale:0;}}</p></li>
                                        <li class="social_gmail"><p style="margin-left: 30px;">Google:{{isset($qSocialGender[1])?$qSocialGender[1]->ageFemale:0;}}</p></li>
                                        <li class=""><p style="margin-left: 250px;"><b>Total:{{isset($socialFemaleTotal[0])?$socialFemaleTotal[0]->ageFemale:0;}}</b></p></li>
                                    </ul>                                
                                </div>
                        </div>
                    </li>
                ...
                <ul class="column">
                    <li class="line">
                        <header class="header">A.1) Total de Participantes por Edad</header>
                        <div id="widget">
                            <div class="eje_y">Participantes</div>
                            <div id="registro">
                                    <ul class="genero">
                                        <li class="rgenerot"><p style="margin-left: 30px;"><b>Total:{{isset($dataAgeTotal[0])?$dataAgeTotal[0]->ageTotal:0;}}</b></p></li>
                                    </ul>                                
                            </div>
                            <canvas id="lineChartTEdad" width="100" height="30"></canvas>
                            <div class="eje_x">Edad</div>

                        </div>
                    </li>
                    <li class="line">
                        <header class="header">A.2) Participantes por Edad	</header>
                        <div id="widget">
                            <div class="eje_y">Participantes</div>
                            <div id="registro">
                                <ul class="genero">
                                    <li class="rgenerom"><p style="margin-left: 30px;">Masculino:{{isset($dataAgeMale[0])?$dataAgeMale[0]->ageMale:0;}}</p></li>
                                    <li class="rgenerof"><p style="margin-left: 30px;">Femenino:{{isset($dataAgeFemale[0])?$dataAgeFemale[0]->ageFemale:0;}}</p></li>
                                </ul>                                
                            </div>
                    ...
                    <li class="line">
                        <header class="header">B.1) Total de Participantes por Pa&iacute;s</header>
                        <div id="widget">
                            <div class="eje_y">Participantes</div>
                            <div id="registro">
                                    <ul class="genero">
                                        <li class="rgenerot"><p style="margin-left: 30px;">Total:{{isset($dataCountryTotal[0])?$dataCountryTotal[0]->countryTotal:0;}}</p></li>
                                    </ul>                                
                            </div>
                            <canvas id="lineChartTPais" height="80"></canvas>  
                            <div class="eje_x">Pa&iacute;s</div>
                        </div>    
                    </li>     
                    <li class="line">
                        <header class="header">B.2) Participantes por Pa&iacute;s	</header>
                        <div id="widget">
                            <div class="eje_y">Participantes</div>
                            <div id="registro">
                                <ul class="genero">
                                    <li class="rgenerom"><p style="margin-left: 30px;">Masculino:{{isset($dataCountryMale[0])?$dataCountryMale[0]->countryMale:0;}}</p></li>
                                    <li class="rgenerof"><p style="margin-left: 30px;">Femenino:{{isset($dataCountryFemale[0])?$dataCountryFemale[0]->countryFemale:0;}}</p></li>
                                </ul>                                
                            </div>
                    ...
                    <li class="line">
                        <header class="header">C.1) Total de Participantes por D&iacute;a	</header>
                        <div id="widget">
                            <div class="eje_y">Participantes</div>
                            <div id="registro">
                                    <ul class="genero">
                                        <li class="rgenerot"><p style="margin-left: 30px;">Total:{{isset($dataDayTotal[0])?$dataDayTotal[0]->dayTotal:0;}}</p></li>
                                    </ul>                                
                            </div>
                            <canvas id="lineChartTDia" height="80"></canvas> 
                            <div class="eje_x">D&iacute;a</div>
                        </div>    
                    </li> 
                    <li class="line">
                        ...
                        <div id="widget">
                            ...
                            <div id="registro">
                                <ul class="genero">
                                    <li class="rgenerom"><p style="margin-left: 30px;">Masculino:{{isset($dataDayMale[0])?$dataDayMale[0]->dayMale:0;}}</p></li>
                                    <li class="rgenerof"><p style="margin-left: 30px;">Femenino:{{isset($dataDayFemale[0])?$dataDayFemale[0]->dayFemale:0;}}</p></li>
                                </ul>                                
                            </div>
                    ...
                    <li class="line">
                        <header class="header">D.1) Total de Participantes por Estado		</header>
                        <div id="widget">
                            <div class="eje_y">Participantes</div>
                            <div id="registro">
                                    <ul class="genero">
                                        <li class="rgenerot"><p style="margin-left: 30px;">Total:{{isset($dataStateTotal[0])?$dataStateTotal[0]->stateTotal:0;}}</p></li>
                                    </ul>                                
                            </div>
                            <canvas id="lineChartTEstado" height="80"></canvas> 
                            <div class="eje_x">Estado</div>
                        </div>    
                    </li> 
                    <li class="line">
                        <header class="header">D.2) Participantes por Estado</header>
                        <div id="widget">
                            <div class="eje_y">Participantes</div>
                            <div id="registro">
                                <ul class="genero">
                                    <li class="rgenerom"><p style="margin-left: 30px;">Masculino:{{isset($dataStateMale[0])?$dataStateMale[0]->stateMale:0;}}</p></li>
                                    <li class="rgenerof"><p style="margin-left: 30px;">Femenino:{{isset($dataStateFemale[0])?$dataStateFemale[0]->stateFemale:0;}}</p></li>
                                </ul>                                
                            </div>
                    ...
                    <li class="line">
                        <header class="header"> E) Participantes por Horas</header>
                        <div style="position: relative; width: 100%; text-align: center;" class="impre">
                            <input type="text" name="request" placeholder="" class="datepicker" data-dateformat='dd/mm/yy'>
                            <button type="" class="btn btn-primary" id="button_registro">Registro</button> 
                        </div>
                    </li>
        ...
        <script>
                ...
                $("#button_registro").click(function() {
                    ...
                    $.ajax({
                        url:'/report-participant/{{$contest_id}}',
                        type:'get',
                ...
                $(document).ready(function() {
                        ...
                        if ($('#donut-graph-Total').length) {
                                Morris.Donut({
                                        ...
                                        data : [{
                                                value : <?=round(((isset($qSocial_network[0])?$qSocial_network[0]->ageTotal:0)*100)/(isset($socialTotal[0])?(($socialTotal[0]->ageTotal>0)?$socialTotal[0]->ageTotal:1):1),2);?>,
                                                label : 'Facebook'
                                        }, {
                                                value : <?=round(((isset($qSocial_network[2])?$qSocial_network[2]->ageTotal:0)*100)/(isset($socialTotal[0])?(($socialTotal[0]->ageTotal>0)?$socialTotal[0]->ageTotal:1):1),2);?>,
                                                label : 'Twitter'
                                        }, {
                                                value : <?=round(((isset($qSocial_network[1])?$qSocial_network[1]->ageTotal:0)*100)/(isset($socialTotal[0])?(($socialTotal[0]->ageTotal>0)?$socialTotal[0]->ageTotal:1):1),2);?>,
                                                label : 'Google'
                                        }],
                        ...
                        if ($('#donut-graph-Hombres').length) {
                                Morris.Donut({
                                        ...
                                        data : [{
                                                value : <?=round(((isset($qSocialGender[0])?$qSocialGender[0]->ageMale:0)*100)/(isset($socialMaleTotal[0])?(($socialMaleTotal[0]->ageMale>0)?$socialMaleTotal[0]->ageMale:1):1),2);?>,
                                                label : 'Facebook'
                                        }, {
                                                value : <?=round(((isset($qSocialGender[2])?$qSocialGender[2]->ageMale:0)*100)/(isset($socialMaleTotal[0])?(($socialMaleTotal[0]->ageMale>0)?$socialMaleTotal[0]->ageMale:1):1),2);?>,
                                                label : 'Twitter'
                                        }, {
                                                value : <?=round(((isset($qSocialGender[1])?$qSocialGender[1]->ageMale:0)*100)/(isset($socialMaleTotal[0])?(($socialMaleTotal[0]->ageMale>0)?$socialMaleTotal[0]->ageMale:1):1),2);?>,
                                                label : 'Google'
                                        }],
                                        formatter : function(x) {
                                                return x + "%"
                        ...
                        if ($('#donut-graph-Mujeres').length) {
                                Morris.Donut({
                                        ...
                                        data : [{
                                                value : <?=round(((isset($qSocialGender[0])?$qSocialGender[0]->ageFemale:0)*100)/(isset($socialFemaleTotal[0])?(($socialFemaleTotal[0]->ageFemale>0)?$socialFemaleTotal[0]->ageFemale:1):1),2);?>,
                                                label : 'Facebook'
                                        }, {
                                                value : <?=round(((isset($qSocialGender[2])?$qSocialGender[2]->ageFemale:0)*100)/(isset($socialFemaleTotal[0])?(($socialFemaleTotal[0]->ageFemale>0)?$socialFemaleTotal[0]->ageFemale:1):1),2);?>,
                                                label : 'Twitter'
                                        }, {
                                                value : <?=round(((isset($qSocialGender[1])?$qSocialGender[1]->ageFemale:0)*100)/(isset($socialFemaleTotal[0])?(($socialFemaleTotal[0]->ageFemale>0)?$socialFemaleTotal[0]->ageFemale:1):1),2);?>,
                                                label : 'Google'
                                        }],
                                        formatter : function(x) {
                                                return x + "%"

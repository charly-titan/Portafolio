@extends(Config::get( 'app.main_template' ).'.versus.main')
    ...
    <div class="versus">
        ...
        @if(count($questionAll->optionsQuestion)==2)   
            ...
            @foreach ($questionAll->optionsQuestion as $key => $value)
                <figure class="poster img1">
                    <div class="poster-imagen">
                        <div class="imagen">
                            <a href="{{'/versus/'.$info->short_name.'/gracias/'.$value['id']}}">
    ...
    <div class="vs-sec-container">
        ...
        @if ((Session::get('user.identifier')!="")&&(Session::get('user.email')!="")&&(Session::get('user.firstname')!=""))
            ...
            <div class="vs-sec-ganaste hidden-smartphone hidden-tablet">
                ...
                <ul class="redes">
                    <li class="twitter">
                        <a href="" title="Twitter" onclick="comm_share.shareTW('https://promociones.televisa.com.mx/versus/{{$info->short_name}}','Un comentario', 'comm_share.callback()');">
                            <i class="c5-twitter"></i>
                        </a>
                    </li>
                    <li class="facebook">
                        <a href="" title="Facebook" onclick="comm_share.shareFB('https://promociones.televisa.com.mx/versus/actividad/{{$info->short_name}}','comm_share.callback()');">
        ...
        @else
            <div class="vs-sec-ganaste hidden-smartphone hidden-tablet">
                <p><b>Gracias por participar</b></p>
            ...
            <div class="modal-dialog">
              ...
              <div class="modal-content">
                ...
                <div class="modal-body">
                  <form role="form" action="/versus/{{$info->short_name}}/confirma" method="post">

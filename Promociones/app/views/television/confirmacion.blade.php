...
@section('content')
    ...
    @endif
    @if(isset($info->properties['colorFont']))
    .main-form .btn-confirmar{background-color:{{$info->properties['colorFont']}}; }
    .main-form .btn{background:{{$info->properties['colorFont']}}; }
    .pika-single .pika-label:first-child:after, .pika-single .pika-label:nth-child(2):after{background:{{$info->properties['colorFont']}};}
    .pika-single .is-selected .pika-button{background:{{$info->properties['colorFont']}};}
    @endif
    {{isset($info->properties['colorFont'])?'.btn-confirma{background:'.$info->properties['colorFont'].'!important;}':''}}
    </style>

...
class Service_Settings:
	...
	def __init__(self):
		...
		self.name_table_configured_services_twitter = self.generic.config["table_configured_services_twitter"]
		...
		self.name_table_configured_services_twitter_versus = self.generic.config["table_configured_services_twitter_versus"]
		...
		self.index_tables = [
								...
								{self.name_table_configured_services_twitter : ["status-service"]},
	...
	def create_tables(self):
		...
		tables = [self.name_table_profiles,self.name_table_hashtags,self.name_table_lists,self.name_table_tweets_service,self.name_table_configured_services_twitter,self.name_table_instagrams]
	...
	def table_configured_services_twitter(self):
		return self.db.table(self.name_table_configured_services_twitter)
	...
	def table_configured_services_twitter_versus(self):
		return self.db.table(self.name_table_configured_services_twitter_versus)
